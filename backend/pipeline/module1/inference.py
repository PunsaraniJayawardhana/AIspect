...
8. Password-type input fields are conventionally expected to display masked input (dots or asterisks) by default and to include a show/hide toggle icon. If a password or confirm password field appears in the explicit ACs without any explicit mention of masking or a show/hide toggle, infer those static UI affordances.
